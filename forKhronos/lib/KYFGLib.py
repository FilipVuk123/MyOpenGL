...
def KYFG_CameraScanEx(handle, bRetainOpenCameras):
    ...
    kydll.KYFG_CameraScanEx.restype = c_longlong
...
def KYFG_CameraInfo2(camHandle):
    ...
    kydll.KYFG_CameraInfo2.restype = c_long
...
def KYFG_GetGrabberValueIntMaxMin(handle, paramName):
    ...
    kydll.KYFG_GetGrabberValueIntMaxMin.restype = c_long
    paramName_str_buf = create_string_buffer(bytes(paramName.encode()))

    grabber_value_int_max = c_longlong(0)
    grabber_value_int_min = c_longlong(0)
...
def KYFG_GetGrabberValueFloatMaxMin(handle, paramName):
    ...
    kydll.KYFG_GetGrabberValueFloatMaxMin.restype = c_long
    paramName_str_buf = create_string_buffer(bytes(paramName.encode()))
...
def KYFG_GetCameraValueIntMaxMin(camHandle, paramName):
    ...
    kydll.KYFG_GetCameraValueIntMaxMin.restype = c_longlong
    paramName_str_buf = create_string_buffer(bytes(paramName.encode()))
    cam_value_int_max = c_longlong(0)
    cam_value_int_min = c_longlong(0)
...
def KYFG_GetCameraValueFloatMaxMin(camHandle, paramName):
    ...
    kydll.KYFG_GetCameraValueFloatMaxMin.restype = c_long
    paramName_str_buf = create_string_buffer(bytes(paramName.encode()))
...
def KYFG_LoadPatternData(streamHandle, type, FixedPatternColor):
    ...
    streamHandle = int(streamHandle)
    c_ulonglong_p = POINTER(c_ulonglong)
    kydll.KYFG_LoadPatternData.argtypes = (c_uint, c_uint, c_ulonglong_p)
    kydll.KYFG_LoadPatternData.restype = c_ulong
...
def KYFG_LoadFileData(streamHandle, path, type, frames):
    ...
    kydll.KYFG_LoadFileData.restype = c_ulong
...
def KYCS_GenerateCxpEvent(handle):
    ...
    kydll.KYCS_GenerateCxpEvent.restype = c_ulong
